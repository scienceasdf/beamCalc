    ...
    ui(new Ui::Widget)
{
    ...
    ui->rResLabel->setVisible(false);
    ui->rResText->setVisible(false);
    ...
    beam1=new simpSupBeam(30,200e9,0.05);
    ...
    qDebug()<<strPath;
    QString strCssFile = strPath + "/qss/beamCalc.qss";
...
void Widget::on_BeamTypeBox_currentIndexChanged(int index)
{
    switch(index){
    case 0:
        ui->rResLabel->setVisible(false);
        ui->rResText->setVisible(false);
        delete beam1;
        beam1=new simpSupBeam(ui->lengthText->text().toDouble(),
                              ui->ElaText->text().toDouble()*1e9,
                              ui->IzText->text().toDouble());
        break;
    case 1:
        ui->rResLabel->setVisible(false);
        ui->rResText->setVisible(false);
        delete beam1;
        beam1=new caBeam(ui->lengthText->text().toDouble(),
                              ui->ElaText->text().toDouble()*1e9,
                              ui->IzText->text().toDouble());
        //ui->label_3->setText(QString::number(beam1->Ela));
        break;
    case 2:
        ui->rResLabel->setVisible(true);
        ui->rResText->setVisible(true);
        delete beam1;
        beam1=new overHangingBeam(ui->lengthText->text().toDouble(),
                              ui->ElaText->text().toDouble()*1e9,
                              ui->IzText->text().toDouble());
        ui->rResText->setText(QString::number(beam1->rRestraint));
        break;
    }
    update();
}

void Widget::on_rResText_textChanged(const QString &arg1)
{
    beam1->rRestraint=arg1.toDouble();
    update();
}
...
void Widget::drawBeam(QPainter& painter)
{
    ...
    //ui->label_3->setText(QString::number(fmax));
    ...
    if(index==1){
        ...
        pen.setWidth(4);
        painter.setPen(pen);
        painter.drawLine(QPoint(250,30),QPoint(250,170));
    ...
    if(index==2){
        ...
        painter.drawLine(QPoint(200+50,100),QPoint(208+50,109));
        painter.drawLine(QPoint(192+50,109),QPoint(208+50,109));
        painter.drawLine(QPoint(200+50+500*beam1->rRestraint/beam1->leng,100),QPoint(192+50+500*beam1->rRestraint/beam1->leng,109));
        painter.drawLine(QPoint(200+50+500*beam1->rRestraint/beam1->leng,100),QPoint(208+50+500*beam1->rRestraint/beam1->leng,109));
        painter.drawLine(QPoint(192+50+500*beam1->rRestraint/beam1->leng,109),QPoint(208+50+500*beam1->rRestraint/beam1->leng,109));
    ...
    //ui->label_3->setText(QString::number(beam1->bend[100]));
}
